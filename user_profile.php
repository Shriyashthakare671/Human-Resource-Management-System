...
<?php
    ...
    {
        $empdata = $jsondata->read_row_data('json/user.json',$_GET["uid"]);
                                ...
                                <div class="card-body">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <input type="text" class="form-control" name="name" id="name" value="<?php echo $name; ?>" placeholder="Enter name" autofocus="" required disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="colFormLabel" class="col-form-label">Email</label>
                                            <input type="email" class="form-control" name="email" id="email" value="<?php echo $email; ?>" required disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="colFormLabel" class="col-form-label">Phone</label>
                                            <input type="number" class="form-control" name="phone" id="phone" value="<?php echo $phone; ?>" required disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="colFormLabel" class="col-form-label">Experience (in year)</label>
                                            <input type="text" class="form-control" name="experience" id="experience" value="<?php echo $experience; ?>" placeholder="Enter experience" required disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="colFormLabel" class="col-form-label">Package (LPA)</label>
                                            <input type="text" class="form-control" name="package" id="package" value="<?php echo $package; ?>" placeholder="Enter package" required disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="colFormLabel" class="col-form-label">SSC (%)</label>
                                            <input type="text" class="form-control" name="ssc" id="ssc" value="<?php echo $ssc; ?>" placeholder="Enter ssc (%)" required disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="colFormLabel" class="col-form-label">Linkedin URL</label>
                                            <input type="text" class="form-control" name="linkedin" id="linkedin" value="<?php echo $linkedin; ?>" placeholder="Enter linkedin url" required disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="colFormLabel" class="col-form-label">Graduation</label>
                                            <input type="text" class="form-control" name="graduation" id="graduation" value="<?php echo $graduation; ?>" placeholder="Enter graduation" required disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="colFormLabel" class="col-form-label">Post Graduation</label>
                                            <input type="text" class="form-control" name="post_graduation" id="post_graduation" value="<?php echo $post_graduation; ?>" placeholder="Enter post graduation" required disabled />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="colFormLabel" class="col-form-label">No. of project</label>
                                            <input type="text" class="form-control" name="no_project" id="no_project" value="<?php echo $no_project; ?>" placeholder="Enter no. of project" required disabled />
                                        </div>
                                    </div>
                                </div>
                            </form>
