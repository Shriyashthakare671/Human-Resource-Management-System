...
<html lang="en">
    ...
    <body>
        <div class="container">
            <form class="sign-in-form" action="submit_signup.php" method="post" autocomplete="off" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="inputPassword" class="sr-only">Resume</label>
                        ...
                        <br><br><center><small>Already have an account? <a href="index.php">Sign In</a></small></center>
                        <?php
